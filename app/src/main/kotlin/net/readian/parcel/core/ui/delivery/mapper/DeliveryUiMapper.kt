...
object DeliveryUiMapper {
  ...
  fun toUiModel(domain: Delivery, carrierName: String? = null): DeliveryUiModel = DeliveryUiModel(
  ...
  private fun toUiModel(domain: DeliveryEvent): DeliveryEventUiModel = DeliveryEventUiModel(
  ...
  private fun getStatusTextRes(status: DeliveryStatus): Int = when (status) {
  ...
  private fun getStatusColor(status: DeliveryStatus): StatusColorUiModel = when (status) {
