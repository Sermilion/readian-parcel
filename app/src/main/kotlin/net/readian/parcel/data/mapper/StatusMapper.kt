...
object StatusMapper {
   ...
   */
  fun toDomain(dataStatus: DeliveryStatusDataModel): DeliveryStatus = when (dataStatus) {
   ...
   */
  fun toData(domainStatus: DeliveryStatus): DeliveryStatusDataModel = when (domainStatus) {
